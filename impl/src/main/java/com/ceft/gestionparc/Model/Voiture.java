...
public class Voiture {
    ...
    //pour la class Archive

    public Voiture(int idV, String matricule, String nom, Date dateEntrer) {
        this.idV = idV;
    ...
    public Voiture(int idV, String matricule, String nom, Date dateEntrer, Date dateSortie) {
        this.idV = idV;
        this.matricule = matricule;
        this.nom = nom;
        this.dateEntrer = dateEntrer;
    ...
    public Voiture(int idV, String matricule, Date dateEntrer, Date dateSortie) {
        this.idV = idV;
        this.matricule = matricule;
        this.dateEntrer = dateEntrer;
        this.dateSortie = dateSortie;
